...
func (a *RecordCRUDApiService) SearchRecord(ctx context.Context, request *SearchRecordRequest) (*SearchRecordResponse, error) {
	...
	if request.LimitRange != nil {
		...
		localVarQueryParams.Add("limit-range", openapi.ParameterToString(request.LimitRange, ""))
	}
	if request.Filter != nil {
	...
	if request.CountIndicator != nil {
		...
		localVarQueryParams.Add("count-indicator", openapi.ParameterToString(request.CountIndicator, ""))
	}
	if request.SupportedFeatures != nil {
	...
	if request.RetrieveRecords != nil {
		...
		localVarQueryParams.Add("retrieve-records", openapi.ParameterToString(request.RetrieveRecords, ""))
	}
	if request.MaxPayloadSize != nil {

		localVarQueryParams.Add("max-payload-size", openapi.ParameterToString(request.MaxPayloadSize, ""))
	}
