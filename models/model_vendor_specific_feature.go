...
type VendorSpecificFeature struct {
	FeatureName string `json:"featureName" yaml:"featureName" bson:"featureName"`
	FeatureVersion string `json:"featureVersion" yaml:"featureVersion" bson:"featureVersion"`
}
