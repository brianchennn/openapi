...
type SubscriptionFilter struct {
	...
	MonitoredResourceUris []*string `json:"monitoredResourceUris,omitempty" yaml:"monitoredResourceUris" bson:"monitoredResourceUris"`
	// list of resources applicable to the subscription
	Operations []*RecordOperation `json:"operations,omitempty" yaml:"operations" bson:"operations"`
}
