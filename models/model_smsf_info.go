...
type SmsfInfo struct {
	RoamingUeInd bool `json:"roamingUeInd,omitempty" yaml:"roamingUeInd" bson:"roamingUeInd"`
	RemotePlmnRangeList []*PlmnRange `json:"remotePlmnRangeList,omitempty" yaml:"remotePlmnRangeList" bson:"remotePlmnRangeList"`
}
