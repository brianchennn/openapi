...
type TagType struct {
	TagName string `json:"tagName" yaml:"tagName" bson:"tagName"`
	KeyType KeyType `json:"keyType" yaml:"keyType" bson:"keyType"`
	Sort bool `json:"sort,omitempty" yaml:"sort" bson:"sort"`
	Presence bool `json:"presence,omitempty" yaml:"presence" bson:"presence"`
}
