...
type RecordSearchResult struct {
	...
	Count int32 `json:"count" yaml:"count" bson:"count"`
	References []*string `json:"references,omitempty" yaml:"references" bson:"references"`
	...
	MatchingRecords map[string]*Record `json:"matchingRecords,omitempty" yaml:"matchingRecords" bson:"matchingRecords"`
}
