...
type NwdafCapability struct {
	AnalyticsAggregation bool `json:"analyticsAggregation,omitempty" yaml:"analyticsAggregation" bson:"analyticsAggregation"`
	AnalyticsMetadataProvisioning bool `json:"analyticsMetadataProvisioning,omitempty" yaml:"analyticsMetadataProvisioning" bson:"analyticsMetadataProvisioning"`
}
