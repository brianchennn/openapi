...
type UriList struct {
	...
	// Links          map[string]*Array `json:"_links,omitempty" yaml:"_links" bson:"_links"`
	TotalItemCount int32 `json:"totalItemCount,omitempty" yaml:"totalItemCount" bson:"totalItemCount"`
}
