...
type ExtSnssai struct {
	...
	Sst int32 `json:"sst" yaml:"sst" bson:"sst"`
	...
	Sd string `json:"sd,omitempty" yaml:"sd" bson:"sd"`
	...
	SdRanges []*SdRange `json:"sdRanges,omitempty" yaml:"sdRanges" bson:"sdRanges"`
	...
	WildcardSd bool `json:"wildcardSd,omitempty" yaml:"wildcardSd" bson:"wildcardSd"`
}
