...
const (
        FlCapabilityType_SERVER FlCapabilityType = "FL_SERVER"
        FlCapabilityType_CLIENT FlCapabilityType = "FL_CLIENT"
        FlCapabilityType_SERVER_AND_CLIENT FlCapabilityType = "FL_SERVER_AND_CLIENT"
)
